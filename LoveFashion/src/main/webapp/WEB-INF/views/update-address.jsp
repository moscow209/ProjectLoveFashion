						...
						<div id="yt_main" class="yt-main-right yt-main col-main col-lg-9 col-md-9 col-sm-8 col-xs-12">
							<div class="yt_main_inner">
								<div class="my-account">
									...
									<form:form action="/customer/account/address" method="post"
										id="form-validate" commandName="addressForm">
										<div class="fieldset">
											<input name="form_key" type="hidden" value="Es77ezna1bhgNX75"> <input type="hidden"
												name="success_url" value=""> <input type="hidden" name="error_url" value="">
												...
												<li class="fields">
													<div class="customer-name row">
														<div class="field name-firstname col-md-6">
															...
															<div class="input-box">
																<form:input path="firstname" value="${firstname}" title="First Name" maxlength="255"
														...
														<div class="field name-lastname col-md-6">
															...
															<div class="input-box">
																<form:input path="lastname" value="${lastname}" title="Last Name" maxlength="255"
                                                                        class="input-text required-entry" />
															</div>
														</div>
													</div>
												...
												<li class="fields">
                                                    <div class="row">
                                                        <div class="field col-md-6">
                                                            ...
                                                            <div class="input-box">
                                                                <form:input path="phone" value="${phone}" title="Phone" maxlength="255"
                                                                        class="input-text required-entry" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
												<li class="wide"><label for="address" class="required"><em>*</em>Address</label>
													<div class="input-box">
														<form:input path="address" value="${address}" title="Address" maxlength="255"
                                                            class="input-text required-entry" />
													</div>
												</li>
											</ul>
										...
										<div class="buttons-set">
											...
											<p class="back-link">
												<a href="http://demo.magentech.com/themes/sm_love_fashion/customer/account/"><small>« </small>Back</a>
											</p>
