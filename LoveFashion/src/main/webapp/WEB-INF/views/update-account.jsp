                                            ...
                                            <div class="fieldset col-md-6">
                                                ...
                                                <ul class="form-list">
                                                    <li class="fields">
                                                        <div class="customer-name row">
                                                            <div class="field name-firstname col-md-6">
                                                                ...
                                                                <div class="input-box">
                                                                    <form:input path="firstName" value="${sessionScope.customer.firstname}" title="First Name" maxlength="255"
                                                            ...
                                                            <div class="field name-lastname col-md-6">
                                                                ...
                                                                <div class="input-box">
                                                                    <form:input path="lastName" value="${sessionScope.customer.lastname}" title="Last Name" maxlength="255"
                                                                        class="input-text required-entry" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="input-box">
                                                            <form:input path="email" value="${sessionScope.customer.email}" title="Email Address" maxlength="255" disabled="true"
                                                                class="input-text" />
                                                        </div>
                                                    </li>
                                                    <li class="control">
