						...
						<div id="yt_main" class="yt-main-right yt-main col-main col-lg-9 col-md-9 col-sm-8 col-xs-12">
							<div class="yt_main_inner">
								<div class="my-account">
									...
									<form:form action="/customer/account/update" method="post" id="form-validate" autocomplete="off" commandName="updateForm">
											...
											<div class="fieldset col-md-6">
												...
												<ul class="form-list">
													...
													<li><label for="email" class="required"><em>*</em>Email Address</label>
														<div class="input-box">
															<form:input path="email" value="${email}" title="Email Address" maxlength="255"
                                                                class="input-text required-entry validate-email" />
														</div></li>
													<li class="control">
													   <form:checkbox path="changePassword" onclick="setPasswordForm(this.checked)" title="Change Password" class="checkbox" />
                                                       <label for="change_password">Change Password</label></li>
												</ul>
											</div>
											<div class="fieldset col-md-6" <c:if test="${param.changepass != 1}">style="display: none;" </c:if>>
