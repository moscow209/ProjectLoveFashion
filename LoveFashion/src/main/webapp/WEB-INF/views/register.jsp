                  ...
                  <div class="account-create">
                    ...
                    <form:form action="/customer/account/register" method="post" id="form-validate" commandName="account">
                            ...
                            <ul class="form-list">
                                ...
                                <div class="customer-name row">
                                  <div class="field name-firstname col-md-6">
                                    ...
                                    <div class="input-box">
                                      ...
                                      <div class="validation-advice"><form:errors path="firstName" /></div>
                                    </div>
                                  </div>
                                  <div class="field name-lastname col-md-6">
                                    ...
                                    <div class="input-box">
                                      ...
                                      <div class="validation-advice"><form:errors path="lastName" /></div>
                                    </div>
                                  </div>
                                </div>
                              </li>
                              <li><label for="email_address" class="required"><em>*</em>Email Address</label>
                                <div class="input-box">
                                  ...
                                  <div class="validation-advice"><form:errors path="email" /></div>
                                </div></li>
                            </ul>
                          </div>
                        </div>
                              ...
                              <li class="fields">
                                <div class="field" style="margin-bottom: 5px;">
                                  ...
                                  <div class="input-box">
                                    ...
                                    <div class="validation-advice"><form:errors path="password" /></div>
                                  </div>
                                </div>
                                <div class="field">
                                  ...
                                  <div class="input-box">
                                    ...
                                    <div class="validation-advice"><form:errors path="confirmPassword" /></div>
                                  </div>
                                </div>
                              </li>
                            </ul>
                      ...
                      <div class="buttons-set">
                        ...
                        <p class="back-link">
                          <a href="http://demo.magentech.com/themes/sm_love_fashion/customer/account/login/" class="back-link"><small>« </small>Back</a>
                        </p>
