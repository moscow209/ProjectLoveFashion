              ...
              <div class="yt-left-wrap">
                <div class="block block-account">
                  ...
                  <div class="block-content">
                    <ul>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/customer/account/">Account Dashboard</a></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/customer/account/edit/">Account Information</a></li>
                      <li class="current"><strong>Address Book</strong></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/sales/order/history/">My Orders</a></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/sales/billing_agreement/">Billing Agreements</a></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/sales/recurring_profile/">Recurring Profiles</a></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/review/customer/">My Product Reviews</a></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/tag/customer/">My Tags</a></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/wishlist/">My Wishlist</a></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/oauth/customer_token/">My Applications</a></li>
                      <li><a href="http://demo.magentech.com/themes/sm_love_fashion/newsletter/manage/">Newsletter Subscriptions</a></li>
                      <li class="last"><a href="http://demo.magentech.com/themes/sm_love_fashion/downloadable/customer/products/">My Downloadable Products</a></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div class="my-account">
                  ...
                  <form:form action="/customer/account/address/edit/id/${address.entityId}" method="post" id="form-validate" commandName="address">
                    ...
                    <div class="buttons-set">
                      ...
                      <p class="back-link">
                        <a href="http://demo.magentech.com/themes/sm_love_fashion/customer/address/"><small>« </small>Back</a>
                      </p>
